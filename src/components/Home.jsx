        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="flex flex-row gap-2">
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="mailto:bijay.tudu213@gmail.com"
              smooth
              duration={500}
              data-aos="fade-up"
              data-aos-delay="1000"
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://www.linkedin.com/in/bijay-tudu-76890/"
              smooth
              duration={550}
              data-aos="fade-up"
              data-aos-delay="2000"
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://github.com/bijay28-dev"
              smooth
              duration={600}
              data-aos="fade-up"
              data-aos-delay="3000"
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://www.instagram.com/code_blaze_28/"
              smooth
              duration={650}
              data-aos="fade-up"
              data-aos-delay="2500"
